...
- [Why C Developers Need Rust](ch01-1-why-c-developers-need-rust.md)<br><span class="zh-inline">为什么 C 开发者需要 Rust</span>
  - [Common C vulnerabilities](ch01-1-why-c-developers-need-rust.md#a-brief-peek-at-some-common-c-vulnerabilities)<br><span class="zh-inline">C 语言中的常见漏洞</span>
  - [Illustration of C vulnerabilities](ch01-1-why-c-developers-need-rust.md#illustration-of-c-vulnerabilities)<br><span class="zh-inline">C 语言漏洞示例</span>
- [Why C++ Developers Need Rust](ch01-2-why-cpp-developers-need-rust.md)<br><span class="zh-inline">为什么 C++ 开发者需要 Rust</span>
  - [C++ challenges that Rust addresses](ch01-2-why-cpp-developers-need-rust.md#c-challenges-that-rust-addresses)<br><span class="zh-inline">Rust 针对的 C++ 难题</span>
  - [C++ memory safety issues (even with modern C++)](ch01-2-why-cpp-developers-need-rust.md#c-memory-safety-issues-even-with-modern-c)<br><span class="zh-inline">即便是现代 C++ 也仍然存在的内存安全问题</span>
