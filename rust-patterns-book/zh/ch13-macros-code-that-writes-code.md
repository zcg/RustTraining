...
> **See also:** [Ch 2 — Traits](ch02-traits-in-depth.md) for when traits and generics beat macros. [Ch 14 — Testing](ch14-testing-and-benchmarking-patterns.md) for testing code generated by macros.<br><span class="zh-inline">**延伸阅读：** 想判断 trait、泛型何时比宏更合适，可以看 [第 2 章：Trait](ch02-traits-in-depth.md)；想看宏生成代码怎么测，可以看 [第 14 章：测试](ch14-testing-and-benchmarking-patterns.md)。</span>
