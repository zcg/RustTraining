...
> **See also:** [Ch 6 — Concurrency](ch06-concurrency-vs-parallelism-vs-threads.md) for threads, Mutex, and shared state. [Ch 16 — Async](ch16-asyncawait-essentials.md) for async channels (`tokio::sync::mpsc`).<br><span class="zh-inline">**继续阅读：** [第 6 章：并发](ch06-concurrency-vs-parallelism-vs-threads.md) 会继续讲线程、Mutex 和共享状态；[第 16 章：Async](ch16-asyncawait-essentials.md) 会讲异步版 channel，例如 `tokio::sync::mpsc`。</span>
